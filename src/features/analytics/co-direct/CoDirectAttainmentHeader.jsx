...
import { ArrowLeft, BookOpen, GraduationCap, User, Target, Layers } from 'lucide-react';

const DIRECT_BLUE = '#0284c7'; // Sky Blue
...
export default function CoDirectAttainmentHeader({
  programmeBatchId,
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
          ...
          >
            ...
            <span>/</span>
            <span style={{ color: DIRECT_BLUE }}>DIRECT ATTAINMENT</span>
          </span>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          >
            <button
              ...
              style={{
                border: 'none',
                background: coScope === 'SELECTED' ? '#0284c7' : 'transparent',
            ...
            <button
              ...
              style={{
                border: 'none',
                background: coScope === 'ALL' ? '#0284c7' : 'transparent',
      ...
      >
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
            ...
            >
              Direct Assessment (80% Weight)
            </span>
          </div>

          <p style={{ fontSize: 13, color: '#64748b', margin: '4px 0 0 0' }}>
            Student marks evidence for direct assessment
          </p>
          ...
          {coScope === 'SELECTED' && coStatement && (
            <div
              style={{
                ...
                padding: '8px 12px',
                background: '#f8fafc',
                borderLeft: `3px solid ${DIRECT_BLUE}`,
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#334155' }}>
            <BookOpen size={13} style={{ color: DIRECT_BLUE }} />
