...
export default function HodDashboard() {
  ...
  const currentProg = selectedProgramme || masterProgrammes[0] || { id: 'prog-1', name: 'B.Tech Computer Science & Engineering', code: 'BE-COMP' };
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '12px', color: '#b45309', marginTop: '1px' }}>
                {nextStep.desc}. Complete this to move your departmental governance forward.
              </div>
            </div>
          </div>
          <button
