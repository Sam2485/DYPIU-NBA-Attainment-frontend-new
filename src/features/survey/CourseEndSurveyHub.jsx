...
import { ClipboardList, Upload, CheckCircle2, FileSpreadsheet, Award, Save, HardDrive, Clock } from 'lucide-react';
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <strong style={{ fontSize: '14px', color: '#14532d' }}>
                    {uploadedFileDetails.fileName || 'survey.xlsx'}
                  </strong>
                  <span className="badge badge-success" style={{ fontSize: '11px' }}>
                    ✓ Survey Document Saved & Verified on Server
                  </span>
                </div>
