...
export default function GeneratedReportsPage({ isEmbedded = false }) {
  ...
  return <div style={{ display: 'flex', minHeight: '100vh' }}><AppSidebar /><main className="nba-layout-main" style={{ flex: 1, minWidth: 0 }}><AppHeader /><div className="page-container">{bodyContent}</div></main></div>;
}
